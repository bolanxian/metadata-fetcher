...
import { bindCall, call, $string } from '../dist/main.ssr.js'
const { slice } = $string
...
const decode = bind(TextDecoder.prototype.decode, new TextDecoder())
...
const { set_title, show_console, tray_init, tray_deinit, tray_notification } = tray.symbols
